...
class Pepit_Auth_Adapter_Doctrine2 implements Zend_Auth_Adapter_Interface
{
    /**
    ...
    /**
     *
     * return an standard object to be loaded in the session through Zend_Auth
     * @param array $properties
     * @return \stdClass 
     */
    public function getResultRowObject($properties)
    {
        // get result from querties
        $userDb = $this->_result;
        
        // transforms Entity into a standard class
        $user = new stdClass();
        foreach ($properties as $property)
        {
            $user->$property = $userDb->$property;
        }  
        return $user;
    }

...
class Pepit_Inflector
{
    ...
    */
    static function titleize($word, $uppercase = '')
    {
        ...
        return $uppercase(Pepit_Inflector::humanize(Pepit_Inflector::underscore($word)));
    }
    ...
    */
    ...
    {
        $word = Pepit_Inflector::camelize($word);
    ...
    */
    ...
    {
        return Pepit_Inflector::pluralize(Pepit_Inflector::underscore($class_name));
    }
    ...
    */
    ...
    {
        return Pepit_Inflector::camelize(Pepit_Inflector::singularize($table_name));
    }

 ...
 */
class Event extends \ZC\Entity\Event implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'date', 'creationDate', 'modificationDate', 'category', 'member');
    }
